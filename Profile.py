...
# SERIALIZATION ASPECTS OF THIS CODE RIGHT NOW,
...
class Post(dict):
    ...
    The property method is used to support get and
    set capability for entry and
...
class Profile:
    ...
    to join an ICS 32 DSU server. You
    will need to use this class to manage the
    information provided by each new user
    created within your program for a2.
    Pay close attention to the properties and
    functions in this class as you will need to
    make use of each of them in your program.

    When creating your program you will need
    to collect user input for the properties
    exposed by this class. A Profile class
    should ensure that a username and password
    ...
    are created, but added to the Profile in a different
    order, it is possible for the
    ...
    all posts that have been added to the Profile object
